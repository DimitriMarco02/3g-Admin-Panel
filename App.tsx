    ...
    const seedDatabase = async () => {
        ...
        try {
            ...
            const subjectsData: Omit<Subject, 'id'>[] = [
                { name: 'Physics', description: 'Explore the laws of the universe from quantum mechanics to cosmology.', imageUrl: 'https://images.unsplash.com/photo-1532187643623-dbf2656d4090?auto=format&fit=crop&q=80&w=800', bannerUrl: 'https://images.unsplash.com/photo-1603126839396-981d36809313?auto=format&fit=crop&q=80&w=1200', feesByLevel: { 'O-Level': 5000, 'AS-Level': 6000, 'A2': 6500 }, createdAt: now.toDate() },
                { name: 'Chemistry', description: 'Dive into the world of atoms, molecules, and chemical reactions.', imageUrl: 'https://images.unsplash.com/photo-1554475901-45389635c249?auto=format&fit=crop&q=80&w=800', bannerUrl: 'https://images.unsplash.com/photo-1627867336984-d33a763c3eba?auto=format&fit=crop&q=80&w=1200', feesByLevel: { 'O-Level': 5000, 'AS-Level': 6000, 'A2': 6500 }, createdAt: now.toDate() },
                { name: 'Biology', description: 'Discover the intricate systems of life, from single cells to entire ecosystems.', imageUrl: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?auto=format&fit=crop&q=80&w=800', bannerUrl: 'https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&q=80&w=1200', feesByLevel: { 'O-Level': 4500, 'AS-Level': 5500, 'A2': 6000 }, createdAt: now.toDate() },
                { name: 'Mathematics', description: 'Master the language of logic, patterns, and problem-solving.', imageUrl: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&q=80&w=800', bannerUrl: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&q=80&w=1200', feesByLevel: { 'O-Level': 5500, 'AS-Level': 6500, 'A2': 7000 }, createdAt: now.toDate() },
            ];
